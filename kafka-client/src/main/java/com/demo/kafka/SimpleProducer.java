...
class SimpleProducer extends AbstractSimpleKafka {
    ...
    protected void send(String topicName, String key, String message) throws Exception {
        ...
        JSONObject obj = MessageHelper.getMessageLogEntryJSON("producer", source, topicName, key, message);
    ...
    private KafkaProducer<String, String> getKafkaProducer() throws Exception {
        if (this.kafkaProducer == null) {
            Properties props = PropertiesHelper.getProducerProperties();
    ...
    public void shutdown() throws Exception {
        closed.set(true);
        log.info(MessageHelper.getSimpleJSONObject("producer", "Shutting down producer"));
